...
if (!function_exists('ky_get_post_value')) {
	...
	function ky_get_post_value($custom_field_definition) {
		...
		$as_array = $custom_field_definition->getType() === kyCustomFieldDefinition::TYPE_CHECKBOX || $custom_field_definition->getType() === kyCustomFieldDefinition::TYPE_MULTI_SELECT || $custom_field_definition->getType() === kyCustomFieldDefinition::TYPE_LINKED_SELECT;
