...
/**
 * Common file to submit a ticket
 *
 * @author Ruchi Kothari
 */
...
if (!isset($_REQUEST['step'])) {
	...
	if (!empty($_POST['departmentid'])) {
		...
		$_customFieldGroupObjectContainer = kyCustomFieldGroup::getAll(array('departmentid' => $_POST['departmentid']))->filterByGroupType(array(
